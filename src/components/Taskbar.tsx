...
const SOCIAL_LINKS = [
  {
    ...
    label: "Behance",
    handle: "@rodriwu",
    url: "https://www.behance.net/rodriwu",
    color: "#1769FF",
    icon: (
  ...
  },
  {
    id: "linkedin",
    label: "LinkedIn",
    handle: "Rodrigo Martínez",
    url: "https://www.linkedin.com/in/rodriwu",
    color: "#0A66C2",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    ...
    label: "Instagram",
    handle: "@rodriwu",
    url: "https://www.instagram.com/rodriwu",
    color: "#E1306C",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
...
export default function Taskbar({
  ...
  // Close all popups when clicking outside the taskbar
  useEffect(() => {
      ...
      <div className="flex flex-col items-center gap-1.5">
        ...
        <div className="relative">
          ...
          {showWifi && (
            ...
            >
              <div
                className="font-mono text-[9px] uppercase tracking-widest px-3 pt-3 pb-1.5"
                  ...
                  >
                    <div
                      ...
                      style={{
                        width: 30,
                        height: 30,
                        background: s.id === "github" ? "rgba(255,255,255,0.08)" : `${s.color}22`,
                        color: s.id === "github" ? "var(--text-primary)" : s.color,
                        border: `1px solid ${s.id === "github" ? "var(--window-border)" : `${s.color}44`}`,
                      }}
                    >
                      {s.icon}
                    </div>
                    <div className="flex flex-col min-w-0">
                      <span className="font-mono text-[10px] font-medium leading-tight" style={{ color: "var(--text-primary)" }}>
                        {s.label}
                      </span>
                      <span className="font-mono text-[9px] leading-tight truncate" style={{ color: "var(--text-tertiary)" }}>
                        {s.handle}
                      </span>
                    </div>
                  </a>
        ...
        {/* Volume — mute toggle + track name on press */}
        <div className="relative">
          <button
            onClick={() => { onToggleMute(); toggleVolume(); }}
        ...
        >
          ...
          {showCalendar && <MiniCalendar anchorRef={calendarAnchor} />}
        </div>
