...
import { Sun, Moon, Wifi, Volume2, VolumeX, Globe, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function Sidebar() {
  const { isDark, toggleTheme, isMuted, toggleMute, locale, setLocale } = useShell();
  ...
  return (
    <div ref={sidebarRef} className="taskbar absolute left-0 top-0 bottom-0 z-40 w-14 flex flex-col items-center justify-between py-3">
